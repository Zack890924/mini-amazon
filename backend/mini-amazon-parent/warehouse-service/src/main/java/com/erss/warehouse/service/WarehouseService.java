...
public class WarehouseService {
    ...
    public PackageOperationResponseDTO packOrder(PackageOperationRequestDTO dto){
        ...
        metricsService.trackStateTransition("package_operation", null, "PACK_PENDING");
    ...
    public PurchaseResponseDTO processPurchase(PurchaseRequestDTO dto){
        ...
        if (needToPurchase){
            ...
            metricsService.trackStateTransition("package_operation", null, "PURCHASE_PENDING");
            packageOperationRepository.save(op);
            ...
            metricsService.trackStateTransition("package_operation", null, "PURCHASE_COMPLETED");
            packageOperationRepository.save(op);
    ...
    public PackageOperationResponseDTO processLoading(PackageOperationRequestDTO dto){
        ...
        metricsService.trackStateTransition("package_operation", null, "LOAD_PENDING");
        packageOperationRepository.save(op);
...
public void handleArrived(ArrivedRequestDTO req){
    ...
    if (matchedOperation != null){
        ...
        metricsService.trackStateTransition("package_operation", "PURCHASE_PENDING", "PURCHASE_COMPLETED");
    ...
    private void createArrivedOperation(Long pkgId){
        ...
        metricsService.trackStateTransition("package_operation", null, "ARRIVED");
    ...
    public void handlePackReady(PackReadyRequestDTO dto){
        ...
        packageOperationRepository
                ...
                .ifPresentOrElse(
                        op -> {
                            op.setStatus("COMPLETED");
                            metricsService.trackStateTransition("package_operation", "PACK_PENDING", "PACK_COMPLETED");
                            packageOperationRepository.save(op);
                        ...
                        () -> {
                            ...
                            op.setStatus("COMPLETED");
                            metricsService.trackStateTransition("package_operation", null, "PACK_COMPLETED");
                            packageOperationRepository.save(op);
        ...
        packageOperationRepository
                ...
                .ifPresentOrElse(
                        op -> {
                            ...
                            op.setStatus("COMPLETED");
                            metricsService.trackStateTransition("package_operation", "LOAD_PENDING", "LOAD_COMPLETED");
                            packageOperationRepository.save(op);
                        ...
                        () -> {
                            ...
                            op.setStatus("COMPLETED");
                            metricsService.trackStateTransition("package_operation", null, "LOAD_COMPLETED");
                            packageOperationRepository.save(op);
